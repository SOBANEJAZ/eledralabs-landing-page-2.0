...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="relative z-100 h-16 px-5 max-w-360 mx-auto flex items-center justify-between bg-transparent transition-colors duration-500 header-inner">
        {/* Logo */}
        ...
        {/* Desktop Nav */}
        <div className="hidden xl:flex items-center flex-1 justify-between ml-5">
          {/* Big Block Nav — shown on viewports ≥ 1400px */}
          <nav className="hidden min-[1400px]:flex items-center gap-1">
            <Link
              className="group flex h-7.5 w-45 items-center justify-between bg-white-soft px-2 font-favorit text-xs text-white transition-colors duration-150 hover:bg-white/20"
              href="/solutions"
            >
          ...
          {/* Pill Nav — shown on viewports ≥ 1280px but < 1400px */}
          <div className="hidden xl:flex min-[1400px]:hidden desktop-pills-hide items-center gap-1 mx-auto">
            <Link
              className="bg-black/60 px-3 py-2 font-favorit text-xs leading-none text-white uppercase backdrop-blur-md transition-colors hover:bg-black/80"
              href="/solutions"
            >
              Solutions
            </Link>
          ...
          <div className="flex items-center gap-1 ml-auto">
            <Link
              className="group inline-flex w-fit shrink-0 items-center justify-center gap-1 whitespace-nowrap font-favorit uppercase transition-colors hover:cursor-pointer focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/60 bg-white text-black min-h-7 px-3 py-2 text-xs leading-none"
              href="/contact"
            >
              Get Started
